...
# GUI: HOW MANY LOOPS DOES THE BUTTON PUSH HAVE TO GO THROUGH BEFORE QUITTING THE APPLICATION
# THIS IS FOR QUITTING THE APPLICATION BY HOLDING THE BUTTON DOWN
GUI_BUTTON_LOOPS_TO_EXIT = 500
